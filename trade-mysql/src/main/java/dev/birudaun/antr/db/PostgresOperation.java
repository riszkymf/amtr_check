...
public class PostgresOperation {
  ...
  private static final String SQL_insertStockData = "INSERT INTO idx_stock_data (security_code, security_name, security_status, security_type, sub_sector, ipo_price, base_price, listed_shares, tradable_listed_shares, shares_per_lot, remarks, security_remarks2, weight) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  
  private static final String SQL_updateStockData = "UPDATE idx_stock_data SET security_name = ?, security_status = ?, security_type = ?, sub_sector = ?, ipo_price = ?, base_price = ?, listed_shares = ?, tradable_listed_shares = ?, shares_per_lot = ?, remarks = ?, security_remarks2 = ?, weight = ? WHERE security_code = ?";
